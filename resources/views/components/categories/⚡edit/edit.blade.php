        ...
        <form wire:submit="update" class="space-y-6">
            ...
            <div>
                ...
                <div wire:ignore
                    ...
                    x-init="
                        ...
                        editor.loadHTML(description);
                        $refs.trixEditor.addEventListener('trix-change', function(e) {
                            content = e.target.value;
                        });
                    ">
                    <input type="hidden" name="description" id="x-description">
                    <trix-editor input="x-description" class="trix-description" x-ref="trixEditor"></trix-editor>
                </div>
            ...
            <div class="mb-4">
                ...
                <div class="mt-1 flex items-center gap-3">
                    ...
                    <button type="button" wire:click.prevent="resetColor"
                        class="px-3 py-2 text-xs font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        Reset Color
                    </button>
                </div>
